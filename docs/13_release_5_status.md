...
- Added AI model selection for AI Import. `Auto` remains the default, and configured models can be selected explicitly per import. Added support for a custom OpenAI-compatible provider, including Responses API and reasoning effort configuration.
